...
The aim of this laboratory was to implement an open-loop camera stabilization system on the TurtleBot using data from its IMU and controlling two servo motors to adjust the tilt and the pan of the camera. 
    ...
    \end{enumerate}
        		...
        		\begin{figure}[H]
			\centering
			\includegraphics[width=0.9\textwidth]{figures/timer_config.jpg}
    ...
    Data logging was performed via the UART interface of the STM32, while using MATLAB to receive and visualize the data in real time with the \verb|serial_datalog()| function. The plots for the yaw compensation and for the tilt compensation can be seen in Figure \ref{fig.lab2.yaw_plot} and Figure \ref{fig.lab2.tilt_plot}, respectively.
    		...
    		\begin{figure}[H]
			\centering
			\includegraphics[width=0.9\textwidth]{figures/plot_yaw_1.png}
    ...
    The data above was obtained by moving the TurtleBot according to the Figure \ref{fig.lab2.yaw_camera}(data for the yaw movement) and Figure \ref{fig.lab2.tilt_camera}(data for the tilt movement), respectively.

    % \begin{figure}[H]
	% 		\centering
	% 		\includegraphics[width=0.9\textwidth]{figures/camera_yaw.jpg}
	% 		\caption{Yaw response behaviour.}
    ...
    %         \begin{figure}[H]
	% 		\centering
	% 		\includegraphics[width=0.9\textwidth]{figures/camera_tilt.jpg}
	% 		\caption{Tilt response behaviour.}
